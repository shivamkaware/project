                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="card mb-4">
                                    <a href="#!">
                                        <img class="card-img-top" width="850px" height="350px" src="{{asset('uploads_image/'.$featured_blog->image)}}" alt="..." />
                                    </a>
                                    <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="card mb-4">
                                            <a href="#!">
                                                @if (empty($blog->image))
                                                <img class="card-img-top" width="500px" height="250px" src="{{asset('downlod1.jpg')}}" alt="..." />

                                                @else

                                                <img class="card-img-top" src="{{asset('uploads_image/'.$blog->image)}}" width="500px" height="250px">
                                                @endif
                                            </a>
                                            <div class="card-body">
